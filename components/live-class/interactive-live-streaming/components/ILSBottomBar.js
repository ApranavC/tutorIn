...
import recordingBlink from "@/components/live-class/static/animations/recording-blink.json";
import useIsRecording from "@/components/live-class/hooks/useIsRecording";
import RecordingIcon from "@/components/live-class/icons/Bottombar/RecordingIcon";
import MicOnIcon from "@/components/live-class/icons/Bottombar/MicOnIcon";
import MicOffIcon from "@/components/live-class/icons/Bottombar/MicOffIcon";
import WebcamOnIcon from "@/components/live-class/icons/Bottombar/WebcamOnIcon";
import WebcamOffIcon from "@/components/live-class/icons/Bottombar/WebcamOffIcon";
import ScreenShareIcon from "@/components/live-class/icons/Bottombar/ScreenShareIcon";
import ChatIcon from "@/components/live-class/icons/Bottombar/ChatIcon";
import ParticipantsIcon from "@/components/live-class/icons/Bottombar/ParticipantsIcon";
import EndIcon from "@/components/live-class/icons/Bottombar/EndIcon";
...
export function ILSBottomBar({
  ...
  return isMobile || isTab ? (
    ...
    <div className="md:flex lg:px-2 xl:px-6 pb-2 px-2 hidden z-10 shrink-0" style={{ height: bottomBarHeight }}>
      <MeetingIdCopyBTN />
