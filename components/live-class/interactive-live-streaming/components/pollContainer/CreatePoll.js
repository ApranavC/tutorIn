              ...
              {options.map((item) => {
                return (
                  <div className="flex items-center mb-4" key={item.optionId}>
                    ...
                    <div
                      className={` ${item.isCorrect && item.option !== ""
                          ? "bg-purple-550"
                          : "bg-customGray-900"
                        } w-full relative rounded  ${isMarkAsCorrectChecked && item.option !== ""
                          ? "ml-2"
                          : "ml-0"
                        }`}
                    >
                      <input
                        type="text"
                        className={`border-none ${item.isCorrect && item.option !== ""
                            ? "bg-purple-550"
                            : "bg-customGray-900"
                      ...
                      >
                        <XCircleIcon
                          className={`h-5 w-5 ${item.isCorrect && item.option !== ""
                              ? "text-white"
                              : "text-gray-400"
                            }`}
                        />
        ...
        <div>
          ...
          <div className="flex">
            ...
            <input
              ...
              className={`border-none ${option.isCorrect && option.option
                  ? "bg-purple-550"
                  : "bg-customGray-900"
